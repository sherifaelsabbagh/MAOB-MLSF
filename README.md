...
Classification versus regression modeling
Structure-based (PLEC) versus combined structure- and ligand-based (PLEC + Morgan fingerprint) featurization
Untuned (baseline) versus hyperparameter-tuned models
