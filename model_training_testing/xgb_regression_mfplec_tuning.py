...
Outputs:
    xgb_regression_mfplec_tuning_history.csv
    xgb_regression_mfplec_tuned_results.csv
    xgb_regression_mfplec_tuned_median_predictions.npy
    XGB_regression_mfplec_tuned_PR_curve.png
"""
...
pd.DataFrame(tuning_log).to_csv('xgb_regression_mfplec_tuning_history.csv', index=False)
print("Saved xgb_regression_mfplec_tuning_history.csv")
...
results_df.to_csv('xgb_regression_mfplec_tuned_results.csv', index=False)
...
np.save('xgb_regression_mfplec_tuned_median_predictions.npy', y_pred)
...
plt.savefig('XGB_regression_mfplec_tuned_PR_curve.png', dpi=200)
print("Saved XGB_regression_mfplec_tuned_PR_curve.png and xgb_regression_mfplec_tuned_median_predictions.npy")
