...
Outputs:
    dnn_classification_tuning_history.csv
    dnn_classification_tuned_results.csv
    dnn_classification_tuned_median_predictions.npy
    DNN_classification_tuned_PR_curve.png
"""
...
pd.DataFrame(tuning_log).to_csv('dnn_classification_tuning_history.csv', index=False)
print("Saved dnn_classification_tuning_history.csv")
...
results_df.to_csv('dnn_classification_tuned_results.csv', index=False)
...
np.save('dnn_classification_tuned_median_predictions.npy', y_score)
...
plt.savefig('DNN_classification_tuned_PR_curve.png', dpi=200)
print("Saved DNN_classification_tuned_PR_curve.png and dnn_classification_tuned_median_predictions.npy")
