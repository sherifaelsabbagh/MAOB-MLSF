...
results_df.to_csv('svm_regression_mfplec_results.csv', index=False)
...
np.save('SVM_mfplec_median_predictions.npy', y_pred)
...
ax.set_title(f'SVM regression (MF+PLEC) — median run (seed={closest_seed})')
plt.savefig('SVM_mfplec_PR_curve.png', dpi=200)
