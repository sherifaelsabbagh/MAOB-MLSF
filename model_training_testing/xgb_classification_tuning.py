...
Outputs:
    xgb_classification_tuning_history.csv
    xgb_classification_tuned_results.csv
    xgb_classification_tuned_median_predictions.npy
    XGB_classification_tuned_PR_curve.png
"""
...
pd.DataFrame(tuning_log).to_csv('xgb_classification_tuning_history.csv', index=False)
print("Saved xgb_classification_tuning_history.csv")
...
results_df.to_csv('xgb_classification_tuned_results.csv', index=False)
...
np.save('xgb_classification_tuned_median_predictions.npy', y_score)
...
plt.savefig('XGB_classification_tuned_PR_curve.png', dpi=200)
print("Saved XGB_classification_tuned_PR_curve.png and xgb_classification_tuned_median_predictions.npy")
