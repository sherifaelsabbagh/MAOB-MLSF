...
results_df.to_csv('rf_regression_mfplec_results.csv', index=False)
...
np.save('RF_mfplec_median_predictions.npy', y_pred)
...
ax.set_title(f'RF regression (MF+PLEC) — median run (seed={closest_seed})')
plt.savefig('RF_mfplec_PR_curve.png', dpi=200)
