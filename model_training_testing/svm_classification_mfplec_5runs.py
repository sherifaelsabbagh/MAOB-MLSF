...
results_df.to_csv('svm_classification_mfplec_results.csv', index=False)
...
np.save('SVM_classification_mfplec_median_predictions.npy', y_score)
...
ax.set_title(f'SVM classification (MF+PLEC) — median run (seed={closest_seed})')
plt.savefig('SVM_classification_mfplec_PR_curve.png', dpi=200)
