...
results_df.to_csv('dnn_classification_mfplec_results.csv', index=False)
...
np.save('DNN_classification_mfplec_median_predictions.npy', y_score)
...
ax.set_title(f'DNN classification (MF+PLEC) — median run (seed={closest_seed})')
plt.savefig('DNN_classification_mfplec_PR_curve.png', dpi=200)
