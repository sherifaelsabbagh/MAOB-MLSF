...
results_df.to_csv('dnn_regression_mfplec_results.csv', index=False)
...
np.save('DNN_mfplec_median_predictions.npy', y_pred)
...
ax.set_title(f'DNN regression (MF+PLEC) — median run (seed={closest_seed})')
plt.savefig('DNN_mfplec_PR_curve.png', dpi=200)
