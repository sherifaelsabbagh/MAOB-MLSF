...
results_df.to_csv('xgb_classification_mfplec_results.csv', index=False)
...
np.save('XGB_classification_mfplec_median_predictions.npy', y_score)
...
ax.set_title(f'XGB classification (MF+PLEC) — median run (seed={closest_seed})')
plt.savefig('XGB_classification_mfplec_PR_curve.png', dpi=200)
