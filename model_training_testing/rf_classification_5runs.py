...
results_df.to_csv('rf_classification_results.csv', index=False)
...
np.save('RF_classification_median_predictions.npy', y_score)
...
ax.set_title(f'RF classification — median run (seed={closest_seed})')
plt.savefig('RF_classification_PR_curve.png', dpi=200)
