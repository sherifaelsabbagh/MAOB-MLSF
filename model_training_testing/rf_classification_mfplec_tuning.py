...
Outputs:
    rf_classification_mfplec_tuning_history.csv
    rf_classification_mfplec_tuned_results.csv
    rf_classification_mfplec_tuned_median_predictions.npy
    RF_classification_mfplec_tuned_PR_curve.png
"""
...
pd.DataFrame(tuning_log).to_csv('rf_classification_mfplec_tuning_history.csv', index=False)
print("Saved rf_classification_mfplec_tuning_history.csv")
...
results_df.to_csv('rf_classification_mfplec_tuned_results.csv', index=False)
...
np.save('rf_classification_mfplec_tuned_median_predictions.npy', y_score)
...
plt.savefig('RF_classification_mfplec_tuned_PR_curve.png', dpi=200)
print("Saved RF_classification_mfplec_tuned_PR_curve.png and rf_classification_mfplec_tuned_median_predictions.npy")
