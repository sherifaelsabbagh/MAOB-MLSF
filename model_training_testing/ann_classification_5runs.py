...
results_df.to_csv('ann_classification_results.csv', index=False)
...
np.save('ANN_classification_median_predictions.npy', y_score)
...
ax.set_title(f'ANN classification — median run (seed={closest_seed})')
plt.savefig('ANN_classification_PR_curve.png', dpi=200)
