...
Outputs:
    svm_classification_tuning_history.csv
    svm_classification_tuned_results.csv
    svm_classification_tuned_median_predictions.npy
    SVM_classification_tuned_PR_curve.png
"""
...
pd.DataFrame(tuning_log).to_csv('svm_classification_tuning_history.csv', index=False)
print("Saved svm_classification_tuning_history.csv")
...
results_df.to_csv('svm_classification_tuned_results.csv', index=False)
...
np.save('svm_classification_tuned_median_predictions.npy', y_score)
...
plt.savefig('SVM_classification_tuned_PR_curve.png', dpi=200)
print("Saved SVM_classification_tuned_PR_curve.png and svm_classification_tuned_median_predictions.npy")
